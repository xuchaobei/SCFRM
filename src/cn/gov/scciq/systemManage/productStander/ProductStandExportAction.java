...
import cn.gov.scciq.basicSettings.accessorySet.AccessoryExportAction;
import cn.gov.scciq.basicSettings.accessorySet.AccessorySetBean;
import cn.gov.scciq.basicSettings.accessorySet.AccessorySetService;
import cn.gov.scciq.util.DefaultResultUtil;

import com.opensymphony.xwork2.Action;
import com.opensymphony.xwork2.ActionSupport;

public class ProductStandExportAction extends ActionSupport{

	private static Log log = LogFactory
			.getLog(ProductStandExportAction.class);
	/**
	 * 
	 */
	...
	public String execute() throws Exception {
		...
		Map<Integer, Object> rsMap=  ProductStanderDao.getProductByQuery(bean, 0, 0);
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "产品编号", "产品名称","产品大类","产品小类","加工方式","包装类型","预期用途"};
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = ProductStandByQueryDto.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
