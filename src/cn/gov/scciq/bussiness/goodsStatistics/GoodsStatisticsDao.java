...
public class GoodsStatisticsDao {
	...
	public static Map<Integer,Object> getStaticResultForGoods(int startYear, int startMonth, int endYear , int endMonth, String productCode, String orgCode,
			String deptCode, String countryCode, String entCode,String productClassCode, String productSubclassCode,
		...
		try {
			...
			proc.setBoolean(12, group_Org);
			proc.setBoolean(13, group_Dept);
			proc.setBoolean(14, group_Country);
			proc.setBoolean(15, group_Ent);
			proc.setBoolean(16, group_ProductClass);
			proc.setBoolean(17, group_ProductSubclass);
			proc.setString(18, inpOrgCode);
			proc.setString(19, inspDeptCode);
			proc.setString(20, roleCode);
			proc.setInt(21, startIndex);
			proc.setInt(22, pageSize);
