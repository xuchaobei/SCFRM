...
public class ForeignReportDetailReqDto {
	...
	public String getNotEffectFlg() {
		return notEffectFlg;
	}
	public void setNotEffectFlg(String notEffectFlg) {
		this.notEffectFlg = notEffectFlg;
	}
