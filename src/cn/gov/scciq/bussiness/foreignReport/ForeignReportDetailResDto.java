...
public class ForeignReportDetailResDto {
    ...
    private String intentedUseName;
    ...
    public void setReportingTitle(String reportingTitle) {
        this.reportingTitle = reportingTitle;
    }
    ...
    public String getMaterialSourceCode() {
        return materialSourceCode;
    }
    public void setMaterialSourceCode(String materialSourceCode) {
        this.materialSourceCode = materialSourceCode;
    }
    public String getMaterialSourceName() {
        return materialSourceName;
    }
    public void setMaterialSourceName(String materialSourceName) {
    ...
    public String getIntentedUseName() {
        return intentedUseName;
    }
    public void setIntentedUseName(String intentedUseName) {
        this.intentedUseName = intentedUseName;
    }
