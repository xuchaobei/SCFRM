...
public class TestResultSearchReqDto {
	...
	public String getDeclDateFlg() {
		return declDateFlg;
	}
	public void setDeclDateFlg(String declDateFlg) {
		this.declDateFlg = declDateFlg;
	}
