 ...
 *
 */
public class ItemStatisticsExportAction extends ActionSupport {

	private static Log log = LogFactory
			.getLog(ItemStatisticsExportAction.class);
	/**
	 * 
	 */
	...
	public String execute() throws Exception {
		...
		String excelName = "项目分析";
		JSONObject rsData= ItemStatisticsService.getStaticResultForItem(data, draw, start, length);
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "项目代码","项目名称","项目类别","产品编号", "产品名称", "出口国家", "产品批次","产品抽中批次", "产品抽中率","产品不合格批次","产品 不合格率" };
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = ItemStatisticsDto.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
