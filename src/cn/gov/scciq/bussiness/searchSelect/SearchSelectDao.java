...
public class SearchSelectDao {
	...
	public static List<ProductDto> getProductByQuery(String entCode,String productName) {
		// TODO Auto-generated method stub
		List<ProductDto> list  = new ArrayList<ProductDto>();
        Connection conn = null;
        CallableStatement proc = null;
        ResultSet rs = null;
        String call = "{call Pro_GetEntProductInput(?,?,?,?,?,?,?,?,?,?)}";
        try {
            conn = DBPool.ds.getConnection();
            proc = conn.prepareCall(call);
            ...
            proc.setString(4, "已审核");
            proc.setString(5, "");
            proc.setString(6, "0");
            proc.setString(7, "0");
            proc.setString(8, "ProductCode");
