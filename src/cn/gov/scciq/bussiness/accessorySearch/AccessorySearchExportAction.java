 ...
 *
 */
public class AccessorySearchExportAction extends ActionSupport {

	private static Log log = LogFactory
			.getLog(AccessorySearchExportAction.class);
	/**
	 * 
	 */
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "辅料名称","企业名称","产品编号","企业产品名称", "用途", "出口国家"};
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = AccessorySearchDto.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
