...
public class ProductCtrlItemDto {
	...
	private String seriousnessLevel;
	private String riskEvlDesc;
	...
	public String getSeriousnessLevel() {
		return seriousnessLevel;
	}

	public void setSeriousnessLevel(String seriousnessLevel) {
		this.seriousnessLevel = seriousnessLevel;
	}

	public String getRiskEvlDesc() {
		return riskEvlDesc;
	}

	public void setRiskEvlDesc(String riskEvlDesc) {
		this.riskEvlDesc = riskEvlDesc;
	}
