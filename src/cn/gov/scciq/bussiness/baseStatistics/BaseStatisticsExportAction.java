 ...
 *
 */
public class BaseStatisticsExportAction extends ActionSupport {

	private static Log log = LogFactory
			.getLog(BaseStatisticsExportAction.class);
	/**
	 * 
	 */
	...
	public String execute() throws Exception {
		...
		String excelName = "原料基地分析";
		JSONObject rsData= BaseStatisticsService.getStaticResultForSampling(data, draw, start, length);
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "基地号", "基地名称", "产品编号", "产品名称", "出口国家","总重量","原料大类", 
				"原料小类","原料细类","总批次","不合格批次","不合格率"};
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = BaseStatisticsDto.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
