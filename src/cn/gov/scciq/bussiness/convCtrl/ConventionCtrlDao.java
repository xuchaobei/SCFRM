...
public class ConventionCtrlDao {
     ...
     * @return
     */
    public static Map<Integer, Object> getConvCtrl( String convctrlTitle,String productClassCode,  String productSubclassCode,  String materialClassCode,  String materialSubclassCode, String materialCode, String materialSourceCode,  String processingMethodCode,  String packageTypeCode,  String intendedUseCode, 
        ...
        try {
            ...
            proc.setString(1, convctrlTitle);
            proc.setString(2, productClassCode);
            proc.setString(3, productSubclassCode);
            proc.setString(4, materialClassCode);
            proc.setString(5, materialSubclassCode);
            proc.setString(6, materialCode);
            proc.setString(7, materialSourceCode);
            proc.setString(8, processingMethodCode);
            proc.setString(9, packageTypeCode);
            proc.setString(10, intendedUseCode);
     ...
     * @return
     */
    public static String saveConvCtrl(String convctrlTitle,String convCtrlID,String productClassCode,String productSubclassCode,String productCode,
        ...
        try {
            ...
            proc.setString(2, convctrlTitle);
            proc.setString(3, productClassCode);
            proc.setString(4, productSubclassCode);
            proc.setString(5, productCode);
            proc.setString(6, materialClassCode);
            proc.setString(7, materialSubclassCode);
            proc.setString(8, materialCode);
            proc.setString(9, materialSourceCode);
            proc.setString(10, processingMethodCode);
            proc.setString(11, packageTypeCode);
            proc.setString(12, intentedUseCode);
     ...
     * 获取国家布控
     */
    public static List<ConventionCtrlCountryResDto> getConvCtrlCounty(String convCtrlID){
        List<ConventionCtrlCountryResDto> list = new ArrayList<ConventionCtrlCountryResDto>();
        Connection conn = null;
        CallableStatement proc = null;
        ResultSet rs = null;
        String call = "{call Pro_GetConvCtrlCounty(?)}";
        try {
            conn = DBPool.ds.getConnection();
            proc = conn.prepareCall(call);
            proc.setString(1, convCtrlID);
            proc.execute();
            rs = proc.getResultSet();
            ConventionCtrlCountryResDto dto = null;
            while(rs.next()){
                dto = RsToDtoUtil.tranRsToDto(rs, ConventionCtrlCountryResDto.class);
                list.add(dto);
            }
        } catch (SQLException e) {
            // TODO Auto-generated catch block
     ...
     * 保存国家项目
     */
    public static String saveConvCtrlCounty(String convCtrlID, String countryCode){
        String retStr = ConstantStr.SAVE_ERROR_MSG;
        Connection conn = null;
        CallableStatement proc = null;
        String call = "{call Pro_SaveConvCtrlCounty(?,?,?,?)}";
        try {
            conn = DBPool.ds.getConnection();
            proc = conn.prepareCall(call);
            proc.setString(1, convCtrlID);
     ...
     * 删除国家布控
     */
    public static boolean delConvCtrlCounty(String convCtrlCountryID){
        boolean retCode = true;
        Connection conn = null;
        CallableStatement proc = null;
        String call = "{call Pro_DelConvCtrlCounty(?)}";
        try {
            conn = DBPool.ds.getConnection();
            proc = conn.prepareCall(call);
            proc.setString(1, convCtrlCountryID);
            proc.execute();
        } catch (SQLException e) {
            // TODO Auto-generated catch block
            retCode = false;
