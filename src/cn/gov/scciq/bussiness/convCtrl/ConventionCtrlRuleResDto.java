 ...
 *
 */
public class ConventionCtrlRuleResDto {

    private String convCtrlID;
    private String convctrlTitle;
    ...
    public String getConvctrlTitle() {
		return convctrlTitle;
	}

	public void setConvctrlTitle(String convctrlTitle) {
		this.convctrlTitle = convctrlTitle;
	}
    ...
    public ConventionCtrlRuleResDto() {
