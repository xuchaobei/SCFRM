...
public class ConventionCtrlAction{
    ...
    private String convCtrlCountryID;
    ...
    public String getConvCtrlCountryID() {
		return convCtrlCountryID;
	}

	public void setConvCtrlCountryID(String convCtrlCountryID) {
		this.convCtrlCountryID = convCtrlCountryID;
	}
    ...
    public String getConvCtrlCounty(){
        result = convCtrlService.getConvCtrlCounty(convCtrlID);
        return Action.SUCCESS;
    }
    ...
    public String saveConvCtrlCounty(){
        result = convCtrlService.saveConvCtrlCounty(data);
        return Action.SUCCESS;
    }
    ...
    public String delConvCtrlCounty(){
        result = convCtrlService.delConvCtrlCounty(convCtrlCountryID);
        return Action.SUCCESS;
    }
}
