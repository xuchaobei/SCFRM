...
public class CtrlPlanDao {
    ...
    public static String saveCtrlPlanImp(String ctrlPlanImpID, String ctrlPlanName, String entCode,
            String productCode, String impDate, String validDays, String regOrgCode, String regDeptCode, String regOperatorCode){
        ...
        try {
            ...
            proc.setString(5, impDate);
            proc.setString(6, validDays);
            proc.setString(7, regOrgCode);
            proc.setString(8, regDeptCode);
            proc.setString(9, regOperatorCode);
     ...
     * @return
     */
    public static String saveCtrlPlanItem(String ctrlPlanItemID, String ctrlPlanImpID, String itemCode, String labData, String dataUnit){
        String retStr = ConstantStr.SAVE_ERROR_MSG;
        Connection conn = null;
        CallableStatement proc = null;
