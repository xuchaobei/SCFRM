...
public class EntProductInputDetailBean {
	private String entProductInputID;
	...
	private String processingDegreeCode;
	private String packageTypeCode;
	private String intentedUseCode;
	...
	public EntProductInputDetailBean() {
		super();
	}
	public String getEntProductInputID() {
		return entProductInputID;
	}
	public void setEntProductInputID(String entProductInputID) {
		this.entProductInputID = entProductInputID;
	}
	...
	public void setProcessingMethodCode(String processingMethodCode) {
		this.processingMethodCode = processingMethodCode;
	}
	public String getProcessingDegreeCode() {
		return processingDegreeCode;
	}
	public void setProcessingDegreeCode(String processingDegreeCode) {
		this.processingDegreeCode = processingDegreeCode;
	}
	...
	public String getIntentedUseCode() {
		return intentedUseCode;
	}
	public void setIntentedUseCode(String intentedUseCode) {
		this.intentedUseCode = intentedUseCode;
	}
	public String getStorageConditionCode() {
		return storageConditionCode;
	}
	public void setStorageConditionCode(String storageConditionCode) {
