...
public class MaterialClassExportAction  extends ActionSupport{
	...
	MaterialClassService service=new MaterialClassService();
	
	public String execute() throws Exception {

		String excelName = "原料类别数据";
		...
		Map<Integer, Object> rsMap=  service.getMaterialClassForExport();
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "原料大类编号", "原料大类名称","原料小类编号", "原料小类名称","原料细类编号", "原料细类名称"};
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = MaterialClassForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
