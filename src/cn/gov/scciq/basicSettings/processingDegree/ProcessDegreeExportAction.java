...
public class ProcessDegreeExportAction  extends ActionSupport{
	...
	ProcessingDegreeService service=new ProcessingDegreeService();
	...
	public String execute() throws Exception {
		...
		Map<Integer, Object> rsMap=  service.GetProcessingDegree(0, 0);
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = ProcessingDegreeForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
