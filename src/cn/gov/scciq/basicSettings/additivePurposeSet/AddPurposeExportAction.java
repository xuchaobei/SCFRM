...
public class AddPurposeExportAction  extends ActionSupport{
	...
	AdditivePurposeService service=new AdditivePurposeService();
	
	public String execute() throws Exception {

		String excelName = "添加剂用途数据";
		...
		Map<Integer, Object> rsMap=  service.GetAdditivePurposeForExport();
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "添加剂用途序号", "添加剂用途名称"};
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = AdditivePurposeForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
