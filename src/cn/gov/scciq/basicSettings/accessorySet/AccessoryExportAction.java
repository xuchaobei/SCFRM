...
public class AccessoryExportAction extends ActionSupport{

	private static Log log = LogFactory
			.getLog(AccessoryExportAction.class);
	/**
	 * 
	 */
	...
	AccessorySetService service=new AccessorySetService();
	
	public String execute() throws Exception {

		String excelName = "辅料设置数据";
		...
		Map<Integer, Object> rsMap=  service.GetAccessory(proBean, 0, 0);
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = AccessorySetBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
