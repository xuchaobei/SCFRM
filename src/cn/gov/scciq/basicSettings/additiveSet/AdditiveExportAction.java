...
public class AdditiveExportAction  extends ActionSupport{
	...
	AdditiveSetService service=new AdditiveSetService();
	
	public String execute() throws Exception {

		String excelName = "添加剂数据";
		System.out.println("ac se "+data);
		//JSONObject rsData= ProductStatisticsService.getStaticResultForProduct(data, draw, 0, 0);
		//JSONObject object = JSONObject.fromObject(data);
		AdditiveSetBean bean=new AdditiveSetBean();
		bean.setAdditiveName("");
		Map<Integer, Object> rsMap=  service.GetAdditive(bean, 0, 0);
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = AdditiveSetBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
