...
public class ExamineItemExportAction  extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		Map<Integer, Object> rsMap=  service.GetItem(bean, 1, 0, 0);
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "检测项目代码", "检测项目名称","风险类别", "风险类别代码","项目类别", "实验室送检"};
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = ItemForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
