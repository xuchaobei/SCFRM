...
public class StorageConditionExportAction  extends ActionSupport{
	...
	StorageConditionService service=new StorageConditionService();
	
	public String execute() throws Exception {

		String excelName = "储存条件数据";
		...
		Map<Integer, Object> rsMap=  service.GetStorageCondition(0, 0);
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = StroageConditionForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
