...
public class ProductClassForExportAction extends ActionSupport{
	...
	ProductClassServiceImpl service=new ProductClassServiceImpl();
	
	public String execute() throws Exception {

		String excelName = "产品类别数据";
		...
		Map<Integer, Object> rsMap=  service.getProductClassForExport();
	...
	private List<String> getTitles() {
		...
		String titiles[] = { "产品大类编号", "产品大类名称","产品小类编号", "产品小类名称"};
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = ProductClassBeanForExport.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
