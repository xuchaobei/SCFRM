...
public class PackageTypeExportAction  extends ActionSupport{
	...
	PackageTypeService service=new PackageTypeService();
	
	public String execute() throws Exception {

		String excelName = "包装类型数据";
		...
		bean.setTypeName("");
		Map<Integer, Object> rsMap=  service.GetPackageType(bean, 1, 0, 0);
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = PackageTypeForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
