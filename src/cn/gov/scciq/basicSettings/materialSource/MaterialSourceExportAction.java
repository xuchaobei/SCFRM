...
public class MaterialSourceExportAction  extends ActionSupport{
	...
	MaterialSourceService service=new MaterialSourceService();
	
	public String execute() throws Exception {

		String excelName = "原料来源数据";
		System.out.println("ac se "+data);
		//JSONObject rsData= ProductStatisticsService.getStaticResultForProduct(data, draw, 0, 0);
		//JSONObject object = JSONObject.fromObject(data);
		MaterialSourceBean bean=new MaterialSourceBean();
		bean.setSourceName("");
		Map<Integer, Object> rsMap=  service.GetMaterialSource(bean, 1, 0, 0);
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = MaterialSourceForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
