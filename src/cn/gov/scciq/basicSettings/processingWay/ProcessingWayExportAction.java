...
public class ProcessingWayExportAction  extends ActionSupport{
	...
	ProcessingWayService service=new ProcessingWayService();
	
	public String execute() throws Exception {

		String excelName = "加工方式数据";
		System.out.println("ac se "+data);
		//JSONObject rsData= ProductStatisticsService.getStaticResultForProduct(data, draw, 0, 0);
		//JSONObject object = JSONObject.fromObject(data);
		ProcessingWayBean bean=new ProcessingWayBean();
		bean.setMethodName("");
		Map<Integer, Object> rsMap=  service.getProductMethod(bean, 1, 0, 0);
	...
	public <T> HSSFWorkbook generateExcel(String excelName,
		...
		try {
			int j = 0;
			Field fields[] = ProcessingWayForExportBean.class.getDeclaredFields();
			for (; j < ja.size(); j++) {
